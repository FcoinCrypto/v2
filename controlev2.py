...
scripts = [
    ...
    {"nom": os.path.join(repertoire_courant, "control_central_gestion_port.py"), "session": "controle_central"},
    ...
    {"nom": os.path.join(repertoire_courant,"serveur_mvola.py"),"session": "serveur_mvola"},
    # ajoute serveur_orange.py
    {"nom": os.path.join(repertoire_courant,"serveur_orange.py"),"session": "serveur_orange"},
    # ajoute serveur_airtel.py
    {"nom": os.path.join(repertoire_courant,"serveur_airtel.py"),"session": "serveur_airtel"}
]
